       		...
       		function iniciar(){
                ...
                function marcar(x){
                    if(jogou == true){
                        ...
                        alert("Você ja marcou a sua jogada");
                    }
    ...
    <body onload="iniciar()">
        ...
        <div class="Jogo">
        	<form id="jogo" action="Servlet">
                    ...
                    <div class="linha">
                        <img id="0" onclick="marcar('0')" src="./img/.png">
                        <img id="1" onclick="marcar('1')" src="./img/.png">
                        <img id="2" onclick="marcar('2')" src="./img/.png">
                    </div>
                    <div class="linha">
                        <img id="3" onclick="marcar('3')" src="./img/a.png">
                        <img id="4" onclick="marcar('4')" src="./img/a.png">
                        <img id="5" onclick="marcar('5')" src="./img/a.png">
                    </div>
                    <div class="linha">
                        <img id="6" onclick="marcar('6')" src="./img/a.png">
                        <img id="7" onclick="marcar('7')" src="./img/a.png">
                        <img id="8" onclick="marcar('8')" src="./img/a.png">
                    </div>
